      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="w-16 h-16 bg-purple-200 rounded-full flex items-center justify-center mb-4">
            <svg className="w-8 h-8 text-purple-800" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"></path>
            </svg>
          </div>
          <h3 className="text-xl font-bold text-purple-800 mb-3">Engage Audiences</h3>
          <p className="text-gray-700">
            Organisations can harness the power of data-driven decision-making, automate workflows across platforms, and deliver personalised, responsive user experiences.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold text-purple-800 mb-3">Integrated</h3>
          <p className="text-gray-700">
            Admins spend more time on analysis and less time on data management, report development, content management etc.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold text-purple-800 mb-3">Customisable</h3>
          <p className="text-gray-700">
            Power Pages has the ability to be further customised and styled using standard programming languages such as HTML, CSS, JavaScript.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold text-purple-800 mb-3">Accessible</h3>
          <p className="text-gray-700">
            Power Pages is designed to be accessible across devices and locations ensuring a consistent, user-friendly experience.
          </p>
        </div>
      </div>
    </div>
