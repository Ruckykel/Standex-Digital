...
const IntelligentCloudSolutions = () => {
  return (
    <section id="intelligentCloudSolutions" className="py-16 bg-gray-50">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-gray-800">Cloud Strategy & Architecture</p>
                </div>
              </li>
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-gray-800">DevOps & CI/CD Pipelines</p>
                </div>
              </li>
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-gray-800">Containerization & Orchestration</p>
                </div>
              </li>
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-gray-800">AI & Machine Learning Models</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-gray-800">Enhanced Flexibility and Scalability</p>
                </div>
              </li>
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-gray-800">Reduced Operational Costs</p>
                </div>
              </li>
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-gray-800">Agile, Reliable Deployment</p>
                </div>
              </li>
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-gray-800">Data-Driven Decision-Making</p>
                </div>
              </li>
            </ul>
          </div>
