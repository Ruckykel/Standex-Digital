          ...
          <div className="lg:w-1/3">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <a href="mailto:info@techhub.com" className="text-blue-600 hover:underline">info@techhub.com</a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="https://www.linkedin.com/company/tech-hub" className="text-blue-600 hover:underline">LinkedIn</a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="https://www.instagram.com/techhub" className="text-blue-600 hover:underline">Instagram</a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="https://twitter.com/techhub" className="text-blue-600 hover:underline">X (Twitter)</a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="https://wa.me/442071234567" className="text-blue-600 hover:underline">WhatsApp</a>
              </div>
            </div>
          </div>
