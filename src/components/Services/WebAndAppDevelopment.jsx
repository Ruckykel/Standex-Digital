...
const WebAndAppDevelopment = () => {
  ...
  return (
    <section id="webAndAppDevelopment" className="py-20 bg-gray-900 w-full">
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Responsive Web Design</p>
                </div>
              </li>
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Native & Cross-Platform Mobile Apps</p>
                </div>
              </li>
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Progressive Web Applications (PWAs)</p>
                </div>
              </li>
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Custom API Development & Integration</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Enhanced User Experience</p>
                </div>
              </li>
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Increased Customer Engagement</p>
                </div>
              </li>
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Improved Performance & Scalability</p>
                </div>
              </li>
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Streamlined Business Processes</p>
                </div>
              </li>
            </ul>
          </div>
