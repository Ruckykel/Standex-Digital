...
const ECommerceSolutions = () => {
  ...
  return (
    <section id="eCommerceSolutions" className="py-20 bg-gray-900 w-full">
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Custom Storefront Design</p>
                </div>
              </li>
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Inventory & Order Management</p>
                </div>
              </li>
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Multi-channel Selling</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Increased Conversion Rates</p>
                </div>
              </li>
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Enhanced Customer Experience</p>
                </div>
              </li>
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Streamlined Operations</p>
                </div>
              </li>
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white">Scalable Growth Platform</p>
                </div>
              </li>
            </ul>
          </div>
